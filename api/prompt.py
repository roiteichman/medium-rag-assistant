...
# ---------------------------------------------------------------------------
# Hyperparameters — must match ingest.py and api/stats.py
# ---------------------------------------------------------------------------
TOP_K             = 5
...
# ---------------------------------------------------------------------------
# Required system prompt (verbatim from assignment spec)
# ---------------------------------------------------------------------------
SYSTEM_PROMPT = (
...
# ---------------------------------------------------------------------------
# Core handler — called by the Vercel handler below
# ---------------------------------------------------------------------------
...
class handler(BaseHTTPRequestHandler):
    ...
    def _respond(self, data: dict, status: int):
